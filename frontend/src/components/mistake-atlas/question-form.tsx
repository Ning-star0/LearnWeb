    ...
    <form action={action} className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_360px]">
      <div className="atlas-card p-6 sm:p-7">
        <div className="grid gap-5 md:grid-cols-2">
          ...
          <label><span className="atlas-label">出处类型 *</span><select name="materialType" className="atlas-input" required defaultValue={initial?.materialType || 'EXERCISE'}><option value="EXAMPLE">书上例题（显示“例”）</option><option value="EXERCISE">课后或习题册（显示“练习”）</option></select></label>
          ...
          <label><span className="atlas-label">书本题号（建议必填）</span><input name="sourceQuestionNumber" className="atlas-input" defaultValue={initial?.sourceQuestionNumber || ''} placeholder="例如 1.9；列表显示为例 1.9 或练习 1.9" /></label>
