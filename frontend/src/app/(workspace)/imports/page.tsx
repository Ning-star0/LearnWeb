  ...
  return <>
    ...
    <div className="grid gap-5 2xl:grid-cols-[minmax(0,1.35fr)_380px]">
      ...
      <aside className="space-y-5">
        ...
        <div className="rounded-2xl border border-blue-200 bg-blue-50 p-5 text-xs leading-6 text-blue-900"><strong>正式模板规则</strong><br />必须包含 schema_version、数学科目、教材、完整章节路径、例题/习题内容类型、题型、首次做错日期、至少一个错误类型，以及“# 题目”“## 我的错因”两个正文区块。勾选自动建立分类后，系统会在预览中列出新增项，确认时与题目一起写入并支持整批回滚。</div>
      </aside>
    </div>
